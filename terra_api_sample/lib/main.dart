  ...
  Future<void> initTerraFunctionState() async {
    ...
    try {
      ...
      initialised = await TerraFlutter.initTerra(
        "diabetes-channel-2MG9VozwwC",
        "187",
      );
      print(initialised?.success);
      connected = await TerraFlutter.initConnection(
        c,
        "5163e1cbc90db27c2f2f1dd1f3aa1df3492c6c7c50f54a7c4165a51093cfbc4a",
        false,
        [],
      );
      ...
      daily = await TerraFlutter.getDaily(c, lastMidnight, now);
